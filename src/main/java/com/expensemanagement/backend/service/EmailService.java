...
public class EmailService {
	...
	private static final String COMPANY_NAME = "Expense Track";
	...
	public int sendOtpMail(String toEmail, String firstName, String lastName) {
		...
		try {
            ...
            // Consider throwing a custom exception or handling the error in another way
            // to inform the user (e.g., store the error in a database, retry sending later).
        }
		return otp;
	}
